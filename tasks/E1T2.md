# E1T2 — Geocode place name and show matches

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 SATB

Integrate with Nominatim to geocode the user's place name input. Show the 3 best matches as inline buttons. Implement in src/handlers/E1T2.ts. Write tests in tests/specs/E1T2.json.
