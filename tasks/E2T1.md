# E2T1 — Date range quick buttons

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 SATB

Implement quick buttons for Last month, Last year, and Custom range. Store the selected option in session state. Implement in src/handlers/E2T1.ts. Write tests in tests/specs/E2T1.json.
