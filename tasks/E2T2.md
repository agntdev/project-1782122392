# E2T2 — Custom date input

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 SATB

Prompt the user for start and end dates (YYYY-MM-DD) when they select the Custom range option. Validate and store the dates in session state. Implement in src/handlers/E2T2.ts. Write tests in tests/specs/E2T2.json.
