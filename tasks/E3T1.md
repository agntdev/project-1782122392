# E3T1 — Composite type options

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 SATB

Implement inline buttons for Composite type: Median composite, Most recent, Custom. Store the selected option in session state. Implement in src/handlers/E3T1.ts. Write tests in tests/specs/E3T1.json.
