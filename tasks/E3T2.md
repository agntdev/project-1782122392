# E3T2 — Visualization options

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 SATB

Implement inline buttons for Visualization: True color (RGB), False color (NIR/Red/Green), NDVI. Store the selected option in session state. Implement in src/handlers/E3T2.ts. Write tests in tests/specs/E3T2.json.
