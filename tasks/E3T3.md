# E3T3 — Cloud-cover slider choices

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 SATB

Implement inline buttons for cloud-cover slider choices: Auto (20%), 10%, 20%, 40%. Store the selected option in session state. Implement in src/handlers/E3T3.ts. Write tests in tests/specs/E3T3.json.
