# E4T1 — Queue processing and send 'processing' message

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 SATB

After the user confirms their query, queue the processing and send a 'processing' message. Implement in src/handlers/E4T1.ts. Write tests in tests/specs/E4T1.json.
