# E4T2 — Send preview JPEG with metadata

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 SATB

When processing is complete, send the preview JPEG (max 1024 px) with metadata (dates used, sensor, cloud cover). Implement in src/handlers/E4T2.ts. Write tests in tests/specs/E4T2.json.
