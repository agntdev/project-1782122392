# E4T3 — Download full-res GeoTIFF button

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 SATB

Add a button for downloading the full-resolution GeoTIFF via a signed S3 link. Implement in src/handlers/E4T3.ts. Write tests in tests/specs/E4T3.json.
