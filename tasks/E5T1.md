# E5T1 — Error messages for no data

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 SATB

Implement error messages for no data scenarios, including suggestions to adjust the query. Implement in src/handlers/E5T1.ts. Write tests in tests/specs/E5T1.json.
