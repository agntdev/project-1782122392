# E6T2 — Recent queries persistence

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 SATB

Implement persistence for recent queries in a small DB (Postgres or SQLite for prototype). Implement in src/handlers/E6T2.ts.
